...
Compute the scheduled arrivals table

Compute the real arrivals table

Compute headways for each:
...
Identify time intervals with similar statistical properties based on headways, and classify each interval in terms of:

punctuality

frequency

Compute punctuality and frequency metrics by comparing scheduled vs. real arrivals for each interval
